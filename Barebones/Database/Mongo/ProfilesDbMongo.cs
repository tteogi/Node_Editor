...
namespace Barebones.MasterServer
{
    ...
    public class ProfilesDbMongo : IProfilesDatabase
    {
        ...
        /// <returns></returns>
        public void RestoreProfile(ObservableProfile profile)
        {
            var data = FindOrCreateData(profile);
            profile.FromStrings(data.Data);
        }

        private ProfileDataMongo FindOrCreateData(ObservableProfile profile)
        {
        ...
        /// </summary>
        /// <param name="profile"></param>
        public void UpdateProfile(ObservableProfile profile)
        {
            var data = FindOrCreateData(profile);
