...
{
    public class GameLobbyAuto : GameLobby
    {
        public float WaitSecondsAfterMinPlayersReached = 10;
        public float WaitSecondsAfterFullTeams = 5;

        public GameLobbyAuto(int lobbyId, IEnumerable<LobbyTeam> teams, LobbiesModule module) 
            : this(lobbyId, teams, module, new LobbyConfig())
        {
        }

        public GameLobbyAuto(int lobbyId, IEnumerable<LobbyTeam> teams, LobbiesModule module, LobbyConfig config) 
