...
{
    /// <summary>
    /// Represents a team within a lobby
    /// </summary>
    public class LobbyTeam
    {
        ...
        {
            if (Members.ContainsKey(member.PlayerSession.Username))
            {
                return false;
            }

            Members.Add(member.PlayerSession.Username, member);
            member.Team = this;
        ...
        {
            Members.Remove(member.PlayerSession.Username);
