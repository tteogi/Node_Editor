...
namespace Barebones.MasterServer
{
    ...
    public class DemoLobbyFactories
    {
        ...
        /// <returns></returns>
        public static GameLobby OneVsOne(LobbiesModule module, Dictionary<string, string> properties)
        {
            // Create the teams
            ...
            // Create the lobby
            var lobby = new GameLobby(module.GenerateLobbyId(), 
        ...
        /// <param name="properties"></param>
        /// <returns></returns>
        public static GameLobby Deathmatch(LobbiesModule module, Dictionary<string, string> properties)
        {
            // Create the teams
        ...
        /// <param name="properties"></param>
        /// <returns></returns>
        public static GameLobby TwoVsTwoVsFour(LobbiesModule module, Dictionary<string, string> properties)
        {
            // Create the teams
            var teamA = new LobbyTeam("Team Blue")
            {
        ...
        /// <param name="properties"></param>
        /// <returns></returns>
        public static GameLobby ThreeVsThreeQueue(LobbiesModule module, Dictionary<string, string> properties)
        {
            // Create the teams
            var teamA = new LobbyTeam("Team Blue")
            {
            ...
            // Create the lobby
            var lobby = new GameLobbyAuto(module.GenerateLobbyId(),
                new[] { teamA, teamB }, module, config)
            {
                Name = ExtractLobbyName(properties)
            }; ;
        ...
        {
            return properties.ContainsKey(GameProperty.GameName) ? properties[GameProperty.GameName] : DefaultName;
        }
    }
}