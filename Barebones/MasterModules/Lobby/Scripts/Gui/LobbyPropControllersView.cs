...
namespace Barebones.MasterServer
{
    ...
    /// </summary>
    public class LobbyPropControllersView : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            LobbyView = LobbyView ?? GetComponentInParent<LobbyView>();
        }
        ...
        public void Setup(List<LobbyPropertyData> propData)
        {
            Properties.Generate(propData, (data, o) =>
            {
                ...
                view.UpdateValue(LobbyView.RawData.LobbyProperties[data.PropertyKey]);
            });
        }
