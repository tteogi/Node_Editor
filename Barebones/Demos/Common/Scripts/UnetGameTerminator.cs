...
public class UnetGameTerminator : MonoBehaviour
{
	...
	[Tooltip("Once every given number of seconds checks if the room is empty." + " If it is - terminates it")]
	...
	private void OnPlayerJoined(GameInfo.Player obj)
	{
		_hasFirstPlayerShowedUp = true;
	}

	private void OnPlayerLeft(GameInfo.Player obj)
	{
